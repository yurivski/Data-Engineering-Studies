...
- **Conceitos:** Normalização, ACID, Modelagem de dados
- **Administração:** Esquemas, migrações, backups
...
- **examples.py / examples.sql:** Código executável
- **assets/:** Screenshots, diagramas, PDFs complementares
...
### Artigos Recentes (LinkedIn/Dev.to)
- [SQL - PostgreSQL: Ordem de Execução](https://dev.to/yurilbrok/sql-postgresql-execution-order-30pk)
...
Este repositório foi criado é para fins educacionais. Sinta-se livre para usar como referência!.
